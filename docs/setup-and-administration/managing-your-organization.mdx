...
Integrating with Trunk through [Webhooks](../flaky-tests/webhooks/), [APIs](apis/), or [CLI](/code-quality/overview/cli/getting-started/install) will require authentication using your organization's slug and token.

You can find your organization slug and token by going to **Settings** > **Organization** > **General**.

<figure><img src="/img/org-slug-and-token.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/org-team-members.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/org-team-members-invite.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/org-team-pending-invites.png" alt="" /><figcaption></figcaption></figure>
...
<Tabs>
<TabItem value="add-first-domain" label="Add First Domain">

<figure><img src="/img/org-team.png" alt="" /><figcaption></figcaption></figure>

</TabItem>
<TabItem value="manage-domains" label="Manage Domains">

<figure><img src="/img/org-team-manage-domain (1).png" alt="" /><figcaption></figcaption></figure>
