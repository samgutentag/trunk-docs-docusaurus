...
Trunk sends basic usage metrics from our local tools ([CLI](../../../install) & [VS Code Extension](../../../ide-integration/vscode)) to our analytics system to help us understand our usage and improve our tools over time. We do not send your code or codebase to our backend.
