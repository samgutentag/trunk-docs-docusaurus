...
<CardGrid>
  ...
  <Card title="How does it work?" description="How Code Quality works under the hood to level up your linting experience." href="/broken/pages/U4nTQBazaodt2vJadyRw" />
  <Card title="Why Code Quality?" description="What makes Trunk Code Quality different from other metalinters." href="/broken/pages/D3BNeTncfBLOHKBJLo8B" />
