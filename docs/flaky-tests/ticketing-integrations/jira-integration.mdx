...
When Trunk Flaky Tests [detects a broken or flaky test](../detection), you can create an automatically generated Jira ticket for your team to pick up and fix the test.
...
<ThemedImage
  alt=""
  sources={{
    light: "/img/jira-connect-form-light.png",
    dark: "/img/jira-connect-form-dark.png",
  }}
/>
...
<ThemedImage
  alt=""
  sources={{
    light: "/img/create-ticket-button-light.png",
    dark: "/img/create-ticket-button-dark.png",
  }}
/>

* Use the Create ticket button in the top left corner of the [test case details](../detection#test-case-details) page.
