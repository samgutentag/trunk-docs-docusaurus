...
<ThemedImage
  alt=""
  sources={{
    light: "/img/pr-test-summary.png",
    dark: "/img/pr-test-summary (1).png",
  }}
/>
...
8.  If everything looks good, scroll down to double check that your Overview for permissions looks something like the image below. If so, create the token.
    ...
    <figure><img src="/img/Screenshot 2024-06-12 at 9.52.28 AM.png" alt="" /><figcaption></figcaption></figure>
