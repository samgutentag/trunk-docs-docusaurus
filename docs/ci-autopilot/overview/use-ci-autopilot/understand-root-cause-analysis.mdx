...
<figure><img src="/img/Screenshot 2025-09-12 at 10.22.02 AM.png" alt="" /><figcaption><p>CI Autopilot PR Comment</p></figcaption></figure>

Each comment includes the following details:

* **Test summary**: A brief description of the issue
* **Affected jobs or tests (when** [**test reports are uploaded**](../get-started/upload-test-reports)**)**: The jobs or a list of all the tests that failed with the same root-cause
...
<CardGrid>
  <Card title="Request fixes on PRs" description="request-fixes-on-prs.md" href="request-fixes-on-prs" />
  <Card title="Apply fixes with MCP" description="apply-fixes-with-mcp.md" href="apply-fixes-with-mcp" />
</CardGrid>
