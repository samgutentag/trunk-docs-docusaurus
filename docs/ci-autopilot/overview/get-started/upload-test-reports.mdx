...
* [CI Autopilot enabled for your GitHub repository](connect-to-github)
...
Select test framework and follow the instructions to configure test reports: [frameworks](../../../flaky-tests/get-started/frameworks/ )
...
Follow the setup guide to upload test results: [github-actions.md](../../../flaky-tests/get-started/ci-providers/github-actions.md )
...
<figure><img src="/img/Screenshot 2025-09-11 at 4.08.51 PM.png" alt="The uploads tab contains results received from past CI jobs." /><figcaption><p>The uploads tab contains results received from past CI jobs</p></figcaption></figure>
