...
If multiple PRs have the same priority, they are processed in the order they were submitted. See [Priority Levels](../optimizations/priority-merging).

**Examples**

<Tabs>
<TabItem value="default-priority" label="Default Priority">
...
<TabItem value="high-priority" label="High Priority">
...
<TabItem value="low-priority" label="Low Priority">
...
<TabItem value="urgent" label="Urgent">
