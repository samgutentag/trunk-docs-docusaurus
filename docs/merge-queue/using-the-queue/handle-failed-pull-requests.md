...
<figure><img src="/img/merge-pr-details-action (1).png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/merge-failures.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/merge-failure-retry.png" alt="" /><figcaption><p>Re-queue a PR if it is currently not in the queue that has failed or been cancelled.</p></figcaption></figure>
