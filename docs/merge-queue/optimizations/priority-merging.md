...
<img src="/img/file.excalidraw (11).svg" alt="Queue with two testing PRs and one pending" class="gitbook-drawing" />
...
<img src="/img/file.excalidraw (12).svg" alt="Queue with two testing PRs and a new higher priority pending PR" class="gitbook-drawing" />
...
<img src="/img/file.excalidraw (13).svg" alt="Queue with an urgent PR moved to the front and a normal PR restarting" class="gitbook-drawing" />
