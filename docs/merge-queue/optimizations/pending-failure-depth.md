...
* [Metrics and monitoring](../administration/metrics) - Track retest rate and queue throughput
* Watch for patterns: Do failures cascade? Are they independent?
* Adjust pending failure depth based on data

**Combine with other optimizations:**

* [Anti-flake protection](anti-flake-protection) - Reduce false failures first
* [Batching](batching) - Understand how pending failure depth affects batch splitting
* [Predictive testing](predictive-testing) - Read the full explanation of how these work together
