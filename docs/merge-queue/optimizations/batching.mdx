...
<figure><img src="/img/1768426960-batching-settings.avif" alt="" /><figcaption></figcaption></figure>
...
<Tabs>
<TabItem value="conservative-approach" label="Conservative approach">
...
<TabItem value="balanced-approach" label="Balanced approach">
...
<TabItem value="aggressive-approach" label="Aggressive approach">
