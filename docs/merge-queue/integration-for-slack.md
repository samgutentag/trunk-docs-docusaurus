...
<figure><img src="/img/Screenshot 2025-10-21 at 4.32.54 PM.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/merge-slack-connect.png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/merge-slack-settings.png" alt="" /><figcaption></figcaption></figure>
...
**Tip:** Want to receive these notifications as personal DMs instead of in a shared channel? Check out our [Personal Slack Notifications](integration-for-slack#personal-slack-notifications) setup guide.
...
**Note:** If your organization isn't already using merge queue Slack notifications to a shared channel, a Slack workspace admin may need to approve the Trunk Slack app before you can connect your personal account. See [Enable Merge Queue Notifications](integration-for-slack#enable-merge-queue-notifications) for details on setting up the initial Slack integration.
...
**Tip:** Want to receive these same notifications in a shared Slack channel instead? Check out our team [Channel Slack Notifications](integration-for-slack#channel-notifications) setup guide.

:::

<figure><img src="/img/SCR-20260202-negj.png" alt="" /><figcaption></figcaption></figure>
...
[Personal notifications](integration-for-slack#personal-slack-notifications) are sent directly to you via Slack DM and only include updates about your own PRs.&#x20;

[Channel notifications](integration-for-slack#channel-notifications) are sent to a shared team channel and include updates about all PRs in the merge queue.&#x20;
...
<figure><img src="/img/SCR-20260202-neph.png" alt="" /><figcaption></figcaption></figure>
