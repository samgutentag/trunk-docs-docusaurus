...
<figure><img src="/img/merge-add-repo (1).png" alt="" /><figcaption></figcaption></figure>
...
<figure><img src="/img/merge-github-comment.png" alt="" /><figcaption></figcaption></figure>
...
* **"Permission denied" errors**: Review the [Branch Protection](configure-branch-protection) guide to ensure `trunk-temp/*` and `trunk-merge/*` branches aren't protected by wildcard rules like `*/*`.
