...
* Define required status checks in your `.trunk/trunk.yaml` [configuration file](configure-ci-status-checks#if-using-draft-pr-mode-default)
...
<figure><img src="/img/merge-github-classic-branch-rules.png" alt="" /><figcaption></figcaption></figure>
