...
<ThemedImage
  alt=""
  sources={{
    light: "/img/4x2 Logos (Light-NoBG).png",
    dark: "/img/4x2 Logos (Dark-NoBG).png",
  }}
/>
...
<CardGrid>
  <Card title="Merge Queue" description="A merge queue to make merging code in GitHub safer and easier" href="merge-queue/merge-queue" />
  <Card title="Flaky Tests" description="Detect, quarantine, and eliminates flaky tests from your codebase" href="flaky-tests/overview" />
</CardGrid>
